...
class SignupUpNutrientsFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.let { bindingNotNull ->
            bindingNotNull.buttonsignup1.setOnClickListener {
                findNavController().navigate(SignupUpNutrientsFragmentDirections.actionSignupUpNutrientsFragmentToFinishregister())
            }
            fillCountries()
        }
    }
